  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4 md:space-x-6">
              <div className="flex items-center space-x-2 sm:space-x-4">
                <button
                  ...
                  className="px-3 sm:px-4 md:px-6 py-2 md:py-3 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-xl transition-all duration-300 hover:opacity-90 flex items-center font-medium shadow-lg shadow-emerald-500/20 text-sm md:text-base"
                >
                ...
                <button
                  ...
                  className="px-3 sm:px-4 md:px-6 py-2 md:py-3 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-xl transition-all duration-300 hover:opacity-90 flex items-center font-medium shadow-lg shadow-purple-500/20 text-sm md:text-base"
                >
      ...
      <div className="max-w-6xl mx-auto p-2 sm:p-4 lg:p-6">
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl shadow-2xl p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">

          <div className="flex flex-wrap justify-between items-center mb-6 sm:mb-8 gap-4">
            <div className="flex flex-wrap items-center gap-2 sm:gap-4">
              <button
                onClick={() => setShowAddHabit(!showAddHabit)}
                className="flex items-center px-3 sm:px-4 md:px-6 py-2 sm:py-3 bg-white/20 hover:bg-white/30 text-white rounded-xl transition-all duration-300 text-sm sm:text-base"
              >
              ...
              <select
                ...
                className="px-3 sm:px-4 py-2 sm:py-3 bg-white/10 border border-white/20 rounded-xl text-white [&>option]:bg-gray-800 [&>option]:text-white text-sm sm:text-base"
              >
              ...
              <select
                ...
                className="px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white [&>option]:bg-gray-800 [&>option]:text-white"
              >
          ...
          {showAddHabit && (
            <form onSubmit={handleAddHabit} className="bg-white/5 backdrop-blur-sm rounded-xl p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8 border border-white/10 shadow-xl">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/5 backdrop-blur-sm border border-white/20 rounded-lg text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-white/50 transition-all duration-300 hover:bg-white/10"
                  required
                />
                <select
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
            {habits
              ...
              <div
                key={habit._id}
                className="bg-white/5 backdrop-blur-sm rounded-xl p-3 sm:p-4 lg:p-6 border border-white/10 hover:bg-white/10 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-xl"
              >
                ...
                <div className="flex justify-between items-center">
                  ...
                  {(!habit.lastCompleted || new Date(habit.lastCompleted).toDateString() !== new Date().toDateString()) && (
                    <button
                      ...
                      className="px-4 py-2 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-lg transition-all duration-300 hover:opacity-90 font-medium shadow-lg shadow-emerald-500/20"
                    >
                      Complete
                    </button>
                  )}
